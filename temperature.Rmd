...
Also, we need a map of Veneto: we used one from the (ISTAT
website)[https://www.istat.it/it/archivio/222527] with
...
plot_spatial_corr <- function(st_name, type) {
    require(gstat)
...
```{r}
plot_spatial_corr("Auronzo", "avg")
plot_spatial_corr("Castelfranco Veneto", "avg")
plot_spatial_corr("Cavallino Treporti", "avg")
plot_spatial_corr("Malo", "avg")
plot_spatial_corr("Porto Tolle - Pradon", "avg")
plot_spatial_corr("Roverchiara", "avg")
```